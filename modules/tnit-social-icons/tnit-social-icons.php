...
class TNITSocialIconsModule extends FLBuilderModule {
    ...
    public function render_social_icon( $i )
    {
        ...
        if ( $social_icon->image_type == 'icon' && !empty( $social_icon->icon ) )
        {
    ...
    public function render_social_photo( $i )
    {
        ...
        if ( $social_icon->image_type == 'photo' )
        {
 ...
 */
FLBuilder::register_module('TNITSocialIconsModule', array(
    'social_icons' => array(
 ...
 */
FLBuilder::register_settings_form('tnit_social_icon_form', array(
