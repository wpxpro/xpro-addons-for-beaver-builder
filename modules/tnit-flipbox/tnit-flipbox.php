...
class TNITFlipBoxModule extends FLBuilderModule {
    ...
    public function get_back_nofollow()
    {
        ...
        {
            if ( $this->settings->back_link_nofollow == 'yes' ) {
    ...
    public function render_back_button()
    {
        if ( 'button' == $this->settings->link_type || 'title-button' == $this->settings->link_type )
        {
            ...
            else if( 'icon' == $button_settings->button_type ){
 ...
 */
FLBuilder::register_module( 'TNITFlipBoxModule', array(
    'flipbox_front'      => array(
 ...
 */
FLBuilder::register_settings_form( 'tnit_flipbox_icon_form', array(
 ...
 * Register a settings form to use in the "form" field type above.
 */
FLBuilder::register_settings_form( 'tnit_flipbox_button_form', array(
