...
class XPROLogoGridModule extends FLBuilderModule {
    ...
    public function render_image($item)
    {
        ...
        else if ( 'url' == $settings->general_image_source &&  !empty($settings->general_image_url) ){
 ...
 */
FLBuilder::register_module('XPROLogoGridModule', array(
    'general'       => array(
...
//Log
FLBuilder::register_settings_form('logo_grid_form', array(
